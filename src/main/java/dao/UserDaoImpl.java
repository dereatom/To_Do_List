...
public class UserDaoImpl implements Dao<User> {
    ...
    public void create(User user) throws UserEmailTakenException, NoSuchUserException {
        ...
        try (Connection conn = JDBConnection.getConnection()) {
            ...
            System.out.println("There was a problem in your create method in UserDao when trying to create a connection to db: \n" + e.getMessage());
        }
    }
...
//            throw new NoSuchUserException("email");
    ...
    public List<User> readAll() {
        ...
        try (Connection conn = JDBConnection.getConnection()) {
            ...
            System.out.println("There was a problem in the readAll() method of your UserDaoImpl class when trying to connect to the database:\n" + e.getMessage());
